...
then
    ...
    then
        ...
        yum install -y wget
        wget -O centos-domain-join.sh https://raw.githubusercontent.com/imabedalghafer/domain-repro/master/centos.sh
        ...
        then
            ...
            echo "Installing wget from yum , in case it was not there" >> $logfile
            yum install -y wget
            wget -O oracle-domain-join.sh https://raw.githubusercontent.com/imabedalghafer/domain-repro/master/oracle.sh
            ...
            then
                ...
                echo "Installing wget from yum , in case it was not there" >> $logfile
                yum install -y wget
                wget -O rhel-domain-join.sh https://raw.githubusercontent.com/imabedalghafer/domain-repro/master/redhat.sh
